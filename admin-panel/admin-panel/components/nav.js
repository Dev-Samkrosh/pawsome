  ...
  return (
    <aside className={(show?'left-0':'-left-full')+" top-0 text-white p-4 fixed w-full bg-blue-900 h-full md:static md:w-auto transition-all"}>
      ...
      <nav className="flex flex-col gap-2">
        ...
        <Link href={'/categorias'} className={pathname.includes('/categorias') ? activeLink : inactiveLink}>
        ...
        <Link href={'/configuacion'} className={pathname.includes('/configuracion') ? activeLink : inactiveLink}>
